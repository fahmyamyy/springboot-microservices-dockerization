...
import com.beyonder.authservice.exception.UserNotFoundException;
...
//        ResponseDTO response = restTemplate.getForObject(USER_SERVICE + "username/" + data, ResponseDTO.class);
